 ...
 */
package eu.europa.ec.fisheries.uvms.config.message.producer;
...
public interface MessageProducer {
    ...
    void sendModuleResponseMessage(TextMessage requestMessage, String response) throws MessageException;

    void sendModuleErrorMessage(@Observes @ErrorEvent EventMessage eventMessage) throws MessageException;
