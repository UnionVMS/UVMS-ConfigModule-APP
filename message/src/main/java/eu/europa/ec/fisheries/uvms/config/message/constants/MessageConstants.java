...
public class MessageConstants {
    ...
    public static final String COMPONENT_MESSAGE_IN_QUEUE = "jms/queue/UVMSConfigEvent";
    public static final String COMPONENT_MESSAGE_IN_QUEUE_NAME = "UVMSConfigEvent";
    public static final String COMPONENT_RESPONSE_QUEUE = "jms/queue/UVMSConfig";
    public static final String QUEUE_DATASOURCE_INTERNAL = "jms/queue/UVMSConfigModel";
